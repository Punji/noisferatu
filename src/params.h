...
void updateTalkie1Params()
{
  int index = (int)(vocabularyCount * pot1_norm * 1.02f) - 12;
  if (index >= vocabularyCount)
    index = vocabularyCount - 1;
  else
    if (index < 0)
      index = 0;

  vocabularyIndex = (uint16_t)index;

  pitchDelta = (int8_t)(64.0f * (pot2_norm - 0.5f));
}

void updateTalkie2Params()
{
  voiceSpeed = 4.0f * pot1_norm - 2.0f;

  pitchDelta = (int8_t)(64.0f * (pot2_norm - 0.5f));
}

void updateTalkie3Params()
{
  int index = (int)(vocabularyCount * pot1_norm * 1.02f) - 12;
  if (index >= vocabularyCount)
    index = vocabularyCount - 1;
  ...
  pitchRange = (int8_t)(64.0f * pot2_norm);
}

void updateTalkie4Params()
{
  silentProb = (uint8_t)(64.0f * pot1_norm);
  repeatProb = (uint8_t)(64.0f * pot2_norm);
}

void updateTalkie5Params()
{
  silentProb = (uint8_t)(64.0f * pot1_norm);
  repeatProb = (uint8_t)(64.0f * pot2_norm);
}

void updateTalkie6Params()
{
  silentProb = (uint8_t)(64.0f * pot1_norm);
  repeatProb = (uint8_t)(64.0f * pot2_norm);
}

void updateTalkie7Params()
{
  silentProb = (uint8_t)(64.0f * pot1_norm);
  repeatProb = (uint8_t)(64.0f * pot2_norm);
}

void updateTalkie8Params()
{
  silentProb = (uint8_t)(64.0f * pot1_norm);
  repeatProb = (uint8_t)(64.0f * pot2_norm);}

void updateTalkie9Params()
{
  silentProb = (uint8_t)(64.0f * pot1_norm);
  repeatProb = (uint8_t)(64.0f * pot2_norm);
}
